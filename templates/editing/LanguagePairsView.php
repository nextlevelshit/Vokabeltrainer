                    ...
                    <div class="row">
                        <div class="col-xs-12 levels">
                            <ul class="">
                                ...
                                <li><a href="?page={$currentController}&target=boxes&action=add&languagePair={$pair.language_pair_id}"><span class="glyphicon glyphicon-inbox"></span> Karteikasten hinzufügen</a></li>
                                ...
                                <li><a href="?page={$currentController}&target=cards&action=add&languagePair={$pair.language_pair_id}"><span class="glyphicon glyphicon-pencil"></span> Karteikarten hinzufügen</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
